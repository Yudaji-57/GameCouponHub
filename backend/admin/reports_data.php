...
// 제보 데이터 가져오기
try {
    // 중복된 데이터를 제거하기 위해 DISTINCT 사용
    $sql = "SELECT DISTINCT `index`, user_id, game_name, coupon_code, reward_details, created_at, approval_status, issue_date, expiration_date, coupon_type FROM coupons_report";
